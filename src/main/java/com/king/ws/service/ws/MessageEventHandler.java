...
public class MessageEventHandler {
    ...
    public void onEvent(SocketIOClient client, AckRequest request, Message data) {
        log.info("messageevent 发来消息：" + data);
        //回发消息
    ...
    @OnEvent(value = "messageeventIn")
    public void onEventIn(SocketIOClient client, AckRequest request, Message data) {
        log.info("messageeventIn 发来消息：" + data);
        //回发消息
        client.sendEvent("messageevent", "我是服务器都安发送的信息");
        //广播消息
        sendBroadcast();
